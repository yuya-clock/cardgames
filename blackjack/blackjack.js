...
function deal(hand1, hand2) {
	...
	let hand1Num = Number(tramp1.replace(/[\D]/g, ""));
	let hand2Num = Number(tramp2.replace(/[\D]/g, ""));
...
const drowCard = (who, hands) => {
	...
	// 引いたカードを数値化
	let drowNum = Number(drow.textContent.replace(/[\D]/g,""));
